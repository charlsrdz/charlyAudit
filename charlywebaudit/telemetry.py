...
def _send_request(text: str) -> None:
    ...
    try:
        ...
        # Falla en silencio para el usuario final, registra localmente
...
def send_telemetry(event_type: str, message: str, details: Any = None) -> None:
    ...
    try:
        ...
        if details:
            ...
            # Limitar longitud si el detalle es muy largo
            if len(details_str) > 1500:
                details_str = details_str[:1500] + "\n... [truncado]"
            # Escapar etiquetas HTML simples en el bloque de código
